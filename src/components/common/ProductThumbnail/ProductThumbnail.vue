...
<template>
  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
    <div class="product-wrap mb-10">
      ...
      <div class="product-content text-left mt-15">
        <h3>
          <router-link
            :to="productRoute(currentProduct.slug, matchingVariant.sku)"
        ...
        <div class="product-price" v-if="hasPrice">
         ...
         <div class="description">
          A flaky, soft, moist, handi-split freezer-to-oven biscuit dough 
          made withwhite wheat flour and 1.5 OZ grain EQ </div>
    </div>
  </div>
   </div>
</template>
